...
namespace ClassifyBot.Annotator.Wunderkind
{
    ...
    /// </summary>
    public class SceneGraph2 : Module
    {
        /// <summary>
        ...
        public SceneGraph2(SimulationApp simUnit)
        {
            _simUnit = simUnit;
        ...
        public SimulationApp SimUnit => _simUnit;
        ...
        private string RenderWindow()
        {
            ...
            var activeWindowText = SimUnit.WindowManager.FocusedWindow?.OnRenderWindow();
            ...
            return SimUnit.WindowManager.FocusedWindow == null ? GAMEMODE_EMPTY_TUI : GAMEMODE_DEFAULT_TUI;
        }
