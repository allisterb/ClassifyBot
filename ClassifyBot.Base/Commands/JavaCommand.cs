...
namespace ClassifyBot
{
    ...
    {
        #region Constructors
        public JavaCommand(string javaHome, string classPath, string className, string javaOptions, params object[] options) : base(javaHome, "java", options)
        {
            this.JavaHome = WorkingDirectory;
        ...
        #region Properties
        public string JavaHome { get; protected set; }
